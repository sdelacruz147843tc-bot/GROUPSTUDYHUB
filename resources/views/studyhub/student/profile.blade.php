...
@section('page')
    ...
    <div class="profile-page-header">
        <div>
            ...
            <p class="page-subtitle">Your student identity.</p>
        </div>
    </div>
    ...
    <section class="content-card profile-banner">
        ...
        <div class="profile-banner-main">
            <span class="profile-eyebrow">Student</span>
    ...
    <div class="profile-layout">
        <form method="POST" action="{{ route('studyhub.student.profile.update') }}">
            ...
            <section class="content-card profile-form-card">
                <div class="profile-form-header">
                    <div>
                        <span class="profile-eyebrow">Details</span>
                        <h3>Edit Profile</h3>
                    </div>
                ...
                <div class="profile-form-grid">
                    ...
                    <label class="profile-field profile-field-full" for="avatar_url">
                        <span>Photo URL</span>
                        <input id="avatar_url" name="avatar_url" type="url" placeholder="Avatar link" value="{{ old('avatar_url', $studentProfileForm['avatar_url']) }}">
                    </label>

                    <label class="profile-field profile-field-full" for="bio">
                        <span>Bio</span>
                        <textarea id="bio" name="bio" maxlength="240" placeholder="Short bio">{{ old('bio', $studentProfileForm['bio']) }}</textarea>
                    </label>
                </div>
            </section>
        </form>
        ...
        <aside class="profile-side-panel">
            <article class="content-card profile-insight-card">
                ...
                <a class="secondary-button" href="{{ route('studyhub.student.theme') }}">Edit Theme</a>
            </article>

            <article class="content-card profile-insight-card">
                <span class="profile-eyebrow">Status</span>
                <h3>{{ $studentProfile['bio'] && $studentProfile['avatar_url'] ? 'Complete' : 'Needs Bio' }}</h3>
                <p>{{ $studentProfile['bio'] && $studentProfile['avatar_url'] ? 'Ready for classmates.' : 'Add a photo and short bio.' }}</p>
            </article>
        </aside>
    </div>
@endsection
